...
colnames(otu_tb16_5000, do.NULL = FALSE)

dim(otu_tb16_5000) #  56116   124
otu_tb16_5000[1:5,1:5]

#select 12 samples from MP-SRF miTags dataset:
tb12<- otu_tb16_5000[,c("MD311", "MD528", "MD778", "MD1176", "MD1421", "MD1517", "MD1672", "MD1857", "MD2243", "MD2821")]
dim(tb12)
tb12[1:5,1:5]
...
amplicons_per_sample_tb16[which(colSums(otu_tb16_5000)<5723)]
#the samples MD2304, MD2332, MD2695 and MD2926 have less than 5723 reads 
